...
fn GeneralPane() -> Element {
    ...
    let browse_for_workdir = move |_| {
        ...
        if let Some(dir) = dialog.pick_folder() {
            workdir_input.set(dir.display().to_string());
        }
    };
        ...
        div { style: "display: flex; flex-direction: column; gap: 20px; max-width: 520px;",
            ...
            div {
                ...
                div { style: "display: flex; gap: 8px; align-items: stretch;",
                    ...
                    button {
                        style: "padding: 0 16px; background: {Theme::ACCENT_LIGHT}; color: {Theme::ACCENT_STRONG}; border: 1px solid rgba(68, 120, 52, 0.18); border-radius: 6px; font-size: 13px; font-weight: 600; cursor: pointer; white-space: nowrap;",
